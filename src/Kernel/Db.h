...
int Raw_IniGetInt(INI_ROOT ini, const std::string & sec, const std::string & key, int default = 0);
float Raw_IniGetFloat(INI_ROOT ini, const std::string & sec, const std::string & key, float default = 0.0);
std::string Raw_IniGetString(INI_ROOT ini, const std::string & sec, const std::string & key, const std::string & default = "");
bool Raw_IniGetBool(INI_ROOT ini, const std::string & sec, const std::string & key, bool default = false);
